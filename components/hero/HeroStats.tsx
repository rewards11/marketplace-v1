...
const HeroStats: FC<{ stats: Props }> = ({ stats }) => {
  ...
  return (
    <div className="main_g grid min-w-full grid-cols-2 items-center gap-[1px] overflow-hidden rounded-lg border-[1px]  dark:border-[#525252] dark:bg-[#525252] md:m-0 md:h-[82px] md:min-w-[647px] md:grid-cols-4 md:gap-2 md:bg-white dark:md:bg-black">
      {/* <div className="main_g_in"> */}
      ...
      <div style={{ backgroundColor: '#4b2f75' }}>
        <Stat name="top offer">
...
const Stat: FC<{ name: string; children: ReactNode }> = ({
  ...
  <div className="flex h-20 flex-col items-center justify-center bg-[#4b2f75] dark:bg-black md:h-auto">
    {children}
