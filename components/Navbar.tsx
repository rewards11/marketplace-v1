        ...
        <div className="header_in">
          ...
          <div style={{ display: "flex", justifyContent: "space-evenly", alignItems: "center",width:'15%' }}>
            <div className="metaportal_fn_button1">
              {/* <CartMenu className="ico_col h-[18px] w-[18px]" />
               */}
              
               <span>
               <FaShoppingCart className="ico_col h-[18px] w-[18px]" />
               </span>
              
            </div>
            <div className="metaportal_fn_button1">
            <span>
            <FaWallet className="ico_col h-[18px] w-[18px]" />
            {/* <img src="/icons/wallet.svg" alt="Wallet Icon" className="ico_col h-[18px] w-[18px]" /> */}
               {/* <ConnectWallet className="ico_col h-[18px] w-[18px]" /> */}
               </span>
            {/* <ConnectWallet /> */}
            </div>
